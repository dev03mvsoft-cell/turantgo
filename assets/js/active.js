...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        // Initialize Premium Gallery with Magnific Popup
        $(".popup-gallery").magnificPopup({
            delegate: '.gallery-card', // Link class inside the container
            type: 'image',
            gallery: {
                enabled: true,
                navigateByImgClick: true,
                preload: [0, 1] // Preload next/prev
            },
            image: {
                tError: '<a href="%url%">The image</a> could not be loaded.',
                titleSrc: function (item) {
                    return 'TurantGo Logistics - ' + (item.el.find('img').attr('alt') || 'Operations');
                }
            },
